...
const HeroSection = () => {
   return (
      <Container id="home" className="grid lg:grid-cols-3 gap-5 text-gray-50 pt-25">
         <div className="col-span-2 flex flex-col justify-center gap-3">
            <h1 className="text-5xl font-bold">Hello! I'm <span className="text-orange-600">Khawn</span></h1>
            <h2 className="text-3xl font-bold">I'm a <span className="text-orange-600">Frontend Developer</span></h2>
            <p>Aspiring Frontend Developer skilled in HTML, CSS, JavaScript, Tailwind CSS, React.js, Next.js and familiar with API integration for CRUD operations.</p>
            ...
            <div>
               <a href="/assets/resume/resume.pdf" download="resume-khawn.pdf" className="inline-block text-orange-600 text-xl font-semibold hover:bg-orange-600 hover:text-gray-950 duration-500 border border-orange-600 px-3 py-1 rounded">Download CV</a>
            </div>
         </div>
         <div className="p-5">
